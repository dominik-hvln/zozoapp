...
export const initializePushNotifications = async (): Promise<void> => {
    ...
    // Dodaj wszystkie listenery PRZED requestPermissions
    console.log('[PUSH] Dodawanie listenerów...');
    ...
    // Poproś o zgodę i zarejestruj urządzenie
    ...
    try {
        ...
        if (result.receive === 'granted') {
            ...
            console.log('[PUSH] Wywołano PushNotifications.register()');
        } else {
